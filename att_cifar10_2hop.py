...
parser.add_argument('--save', type=str, default='./att_CIFAR10_2HOP') 
...
if __name__ == '__main__':
    ...
    feature_layers = [ODEBlock_t(ODEfunc_single_conv_nonConcat(dim = NC, N = 7, epsilon = args.epsilon), reif_time)]
    ...
    model = nn.Sequential(*downsampling_layers, *concat_layer, *feature_layers, *norm_layer_before_reif, *reification_layers, *fc_layers).to(device)
