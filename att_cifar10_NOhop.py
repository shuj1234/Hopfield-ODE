...
parser.add_argument('--save', type=str, default='./att_CIFAR10_NOHOP') 
...
if __name__ == '__main__':
    ...
    reification_layers = [ODEBlock_t(ODEfunc(NC), reif_time)] 
    ...
    model = nn.Sequential(*downsampling_layers, *feature_layers, *reification_layers, *fc_layers).to(device)  
